        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="shop-cat-box">
                    ...
                    <a class="btn hvr-hover" href="{{ route('product.index',['slug'=>$item->slug,'id'=>$item->id]) }}">{{ $item->name }}</a>
                </div>
            ...
            <div class="col-lg-3 col-md-6 special-grid best-seller">
                <div class="products-single fix">
                    <div class="box-img-hover">
                        ...
                        <img src="{{ asset('storage/'.$value->avatar) }}" class="img-fluid" alt="Image">
                        <div class="mask-icon">
                            <ul>
                            ...
                            <a class="cart" href="{{ route('cart.add',$value->id) }}">Add to Cart</a>
                        </div>
                    </div>
                    <div class="why-text">
                        <h4>{{ $value->name }}</h4>
