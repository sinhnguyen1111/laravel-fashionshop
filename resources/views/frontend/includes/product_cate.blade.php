                    ...
                    <div class="filter-sidebar-left">
                        ...
                        <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men">
                            ...
                            <div class="list-group-collapse sub-men">
                                <a class="list-group-item list-group-item-action" href="#sub-men1" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">{{ $value->name }} <small class="text-muted">(100)</small>
                            </a>
                                <div class="collapse show" id="sub-men1" data-parent="#list-group-men">
                                    @foreach ($value->categoryChildrent as $categorychild)
                                    <div class="list-group">
                                       
                                        <a href="{{ route('product.index',['slug'=> $categorychild->slug,'id'=>$categorychild->id]) }}" class="list-group-item list-group-item-action ">{{ $categorychild->name }} <small class="text-muted">(50)</small></a>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                        <div class="products-single fix">
                                            <div class="box-img-hover">
                                                ...
                                                <img src="{{ asset('storage/'.$product->avatar) }}" class="img-fluid" alt="Image">
                                                <div class="mask-icon">
                                                    <ul>
                                                    ...
                                                    <a class="cart" href="{{ route('frontend.product.show',$product->id) }}">Xem</a>
                                                </div>
                                            </div>
                                            <div class="why-text">
                                                <h4><a href="">{{ $product->name }}</a></h4>
                                                {{-- <h5>{{ number_format($product->origin_price) }} VNĐ</h5> --}}
                                                <h5>{{ number_format($product->sale_price) }} VNĐ</h5>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
